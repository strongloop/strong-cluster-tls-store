 ...
 *   e.g. `https.Server`.
 * @param {String} [optional] Optional namespace to distinguish between multiple TLS servers. The namespace must be unique within the application and same across all worker processes.
 */
